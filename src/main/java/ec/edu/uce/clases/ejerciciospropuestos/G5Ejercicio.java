...
public class G5Ejercicio {
    public static void main(String[] args) {
        try {
            File entradaFondo = new File("src\\main\\resources\\image\\paisaje.png");
            File entradaFiltro = new File("src\\main\\resources\\image\\universo.png");
            File archivoSalida = new File("src\\main\\resources\\image\\ExamenTema8.png");
            ...
            java.awt.Graphics2D grTmp = imgUniverso.createGraphics();
            ...
            System.out.println("Imagen con filtro generada correctamente.");
