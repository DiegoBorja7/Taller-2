...
public class G1ZBuffer extends JPanel {
    ...
    private void renderizar() {
        ...
        dibujarCuadrado(100, 100, 200, zA, Color.RED);
        dibujarCuadrado(250, 200, 200, zB, Color.BLUE);
        repaint();
    }
    ...
    public static void main(String[] args) {
        ...
        G1ZBuffer simulador = new G1ZBuffer();
        ...
        sA.addChangeListener(e -> {
            simulador.zA = sA.getValue() / 100f;
            simulador.renderizar();
        });
        sB.addChangeListener(e -> {
            simulador.zB = sB.getValue() / 100f;
            simulador.renderizar();
        });

        controles.add(new JLabel("Profundidad Roja:"));
        controles.add(sA);
        controles.add(new JLabel("Profundidad Azul:"));
        controles.add(sB);
