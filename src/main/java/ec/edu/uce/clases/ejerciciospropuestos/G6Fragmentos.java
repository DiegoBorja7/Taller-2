...
public class G6Fragmentos {
    public static void main(String[] args) {
        try {
            // Cargar imágenes
            BufferedImage img1 = ImageIO.read(new File("src\\main\\resources\\image\\Minion.jpg"));
            BufferedImage img2 = ImageIO.read(new File("src\\main\\resources\\image\\perro.jpg"));
            ...
            ImageIO.write(stencil, "jpg", new File("src\\main\\resources\\image\\Stencil.jpg"));
            System.out.println("Imagen generada con Stencil.");

            // Redimensionar la segunda imagen
            BufferedImage img2Red = new BufferedImage(stencil.getWidth(), stencil.getHeight(),
            ...
            ImageIO.write(blending, "jpg", new File("src\\main\\resources\\image\\Blending.jpg"));
            System.out.println("Imagen generada con Blending.");

            // Aplicar XOR
            BufferedImage resultado = aplicarXOR(blending, img2Red);
            ImageIO.write(resultado, "jpg", new File("src\\main\\resources\\image\\ResultadoFinal.jpg"));
            System.out.println("Imagen generada con XOR.");
    ...
    // BLENDING
    public static BufferedImage aplicarBlending(BufferedImage fondo, BufferedImage superior, float alpha) {
