...
public class G2Capas3D extends JFrame {
private double[] zValues = {1.5, 2.5, 3.5};
    ...
    private void initTextures() {
        try {
            ...
            textures[2] = ImageIO.read(new File("src\\main\\resources\\image\\anime-night-sky-illustration.jpg"));
        } catch (Exception e) {
            for (int i = 0; i < 3; i++) {
